...
public class LocationsPOJO {
    ...
    public Map<String, LocationsPOJO> getLocations()
    {
        Map<String, LocationsPOJO> map = new HashMap<>();
            map.put("AllTransitionPaths",new LocationsPOJO("AllTransitionPaths","src/SUT/tests/AllTransitionsTestSuite.java","src/SUT/tests/user_AllTransitionsTestSuite.java"));
            map.put("sneakPath",new LocationsPOJO("sneakPath","src/SUT/tests/SneakPathTestSuit.java","src/SUT/tests/user_SneakPathTestSuit.java"));
            map.put("UnitTests",new LocationsPOJO("UnitTests","src/niSUT/tests/UnitTests.java","src/niSUT/tests/user_UnitTests.java"));
